...
@InputType()
class ConnectionCreateNestedManyWithoutConnectionsInput {
...
export { ConnectionCreateNestedManyWithoutConnectionsInput as ConnectionCreateNestedManyWithoutConnectionsInput };
